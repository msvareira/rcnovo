        ...
        <div class="card my-5">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h4 class="f-w-500 mb-1">Acessar o sistema</h4>
                        <!--
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex mt-1 justify-content-between align-items-center">
                        <div class="form-check">
                            ...
                            <label class="form-check-label text-muted" for="remember">Manter Login?</label>
                        </div>
                        <a href="{{ route('password.request') }}">
                            <h6 class="f-w-400 mb-0">Esqueceu sua senha?</h6>
                        </a>
                    </div>
